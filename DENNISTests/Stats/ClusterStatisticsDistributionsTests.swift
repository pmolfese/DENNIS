...
struct ClusterStatisticsDistributionsTests {
    ...
    @Test func aFixedStatisticThresholdMeansDifferentThingsAtDifferentSubjectCounts() {
        // The reason the probability threshold exists at all: |t| = 2.0 is not
        // "p < .05" at group N, it is barely p < .12.
