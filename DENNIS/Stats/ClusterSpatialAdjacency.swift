...
//
//  Distances are measured in the normalized 2D sensor projection built by
//  `SensorLayout`, where the head outline has unit radius. A neighbor distance
//  of 0.25 therefore means a quarter of the head radius regardless of montage
//  size.
//
//  References (full citations in `References.swift`):
//    - Oostenveld, Fries, Maris & Schoffelen (2011), Comput Intell Neurosci
//      2011:156869 — the `distance` and K-nearest neighborhood conventions this
//      mirrors, as used by FieldTrip.
//    - Maris & Oostenveld (2007), J Neurosci Methods 164(1):177-190 — why the
//      neighborhood definition is part of the test rather than a display
//      setting: it determines which clusters can form at all.
//
...
nonisolated struct ClusterAdjacencyConfiguration: Sendable, Equatable, Hashable {
