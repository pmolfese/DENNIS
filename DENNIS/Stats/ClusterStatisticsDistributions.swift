...
//  statistic. A raw threshold means different things as subject counts change —
//  |t| = 2.0 is p = .046 at 30 subjects but p = .184 at 2 — so a df-aware
...
//    - NIST Digital Library of Mathematical Functions, DLMF 8.17.22 — the
//      continued fraction for the regularized incomplete beta function.
//    - Lentz (1976), Appl Opt 15(3):668-671 — the continued-fraction evaluation
//      method used to sum it.
//    - Lanczos (1964), SIAM J Numer Anal Ser B 1:86-96 — the log-gamma
//      approximation, g = 7, n = 9.
//    - Groppe, Urbach & Kutas (2011), Psychophysiology 48(12):1711-1725 — why a
//      df-aware threshold is preferable to a fixed statistic in ERP work.
//
...
nonisolated enum ClusterStatisticsDistributions {
    ...
    /// over the range of degrees of freedom any study can produce.
